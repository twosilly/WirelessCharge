...
void MagneticField_Init(void)
{
  SystemCoreClockUpdate(); 
	SYSCON->SYSAHBCLKCTRL |= (SYSCON_SYSAHBCLKCTRL_PWMEN | SYSCON_SYSAHBCLKCTRL_GPIOAEN | SYSCON_SYSAHBCLKCTRL_GPIOBEN);
  ...
  //IOCFG->PB1 = IOCFG_DEFAULT | IOCFG_PB1_FUNC_PWM_OUT5;
  //GPIOB->DIR = GPIOB->DIR | GPIO_PIN_1;
